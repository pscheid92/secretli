...
The frontend SHALL have a Layout component that wraps all pages with a navigation header and footer. The navigation SHALL include links to Share (`/`), File (`/file`), and Login (`/login`).

#### Scenario: Navigation links present
- **WHEN** any page renders
- **THEN** the Layout component is visible with navigation links to Share, File, and Login
